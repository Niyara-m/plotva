...
#Подключение к боту
bot = telebot.TeleBot('5837274163:AAEdO4vTzKPao1wTRQ-Xi94W7_UA51zxDFo')
...
def cart_handle(call):
    ...
    if call.data == 'clear':
        ...
        bot.send_message(850935662,'Новый заказ!')
        db.del_cart(user_id)
...
def get_loc(message, user_name, user_num):
    ...
    if message.location:
        ...
        bot.send_message(user_id, 'Вы успешно зарегистрировались!', reply_markup=remove())
        products = db.get_pr_name_id()
